  ...
  return (
    <div className="p-4">
      <header className="flex justify-between items-center bg-white shadow p-4 mb-4">
        <h2 className="text-xl text-center font-bold">Housings</h2>
      </header>
      ...
      <section id="table-container" className="space-y-4 overflow-x-scroll">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex gap-2">
            <Button variant="destructive">Delete all Housings</Button>
            <Button variant="outline">Import Housings</Button>
            <Button onClick={toggleModal}>New housing</Button>
          </div>
        </div>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-500 bg-opacity-50">
            <div className="bg-white rounded-md p-4 w-11/12 max-w-lg shadow-lg">
              <form>
                <h5 className="text-xl font-semibold mb-4">Add new Housing</h5>
                <div className="mb-4">
                  <label>Name*</label>
                  <input
                    type="text"
